...
{
#Load Dataset
bbPerFrame <- read.csv("./03_Datasets/dataset_1/boundingboxes_class1.csv")
...
setwd(parent_dir)
setwd("./04_Results/")
write.csv(clusterResults, 'class_1_nCluster_onTestLabels.csv', row.names=FALSE)
}
...
#Nmax - On the test labels
{
  ...
  setwd(parent_dir)
  setwd("./04_Results/")
  write.csv(nmaxResults, 'class_1_nMax_onTestLabels.csv', row.names=FALSE)  
}
...
#NCluster - On the fully automated labels
{
  ...
  #Load Dataset
  bbPerFrame <- read.csv("./03_Datasets/dataset_1/boundingboxes_class1_fullyAuto.csv")
  ...
  setwd(parent_dir)
  setwd("./04_Results/")
  write.csv(clusterResults, 'class_1_nCluster_onDetections.csv', row.names=FALSE)
}
...
#Nmax - On the fully automated labels
{
  ...
  setwd(parent_dir)
  setwd("./04_Results/")
  write.csv(nmaxResults, 'class_1_nMax_onDetections.csv', row.names=FALSE)  
}
