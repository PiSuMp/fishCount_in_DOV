...
{
#Load Dataset
bbPerFrame <- read.csv("./03_Datasets/dataset_13/boundingboxes_class13.csv")
...
setwd(parent_dir)
setwd("./04_Results/")
write.csv(clusterResults, 'class_13_nCluster_onTestLabels.csv', row.names=FALSE)
}
...
#Nmax - On the test labels
{
  ...
  setwd(parent_dir)
  setwd("./04_Results/")
  write.csv(nmaxResults, 'class_13_nMax_onTestLabels.csv', row.names=FALSE)  
}
...
#NCluster - On the fully automated labels
{
  ...
  #Load Dataset
  bbPerFrame <- read.csv("./03_Datasets/dataset_13/boundingboxes_class13_fullyAuto.csv")
  ...
  setwd(parent_dir)
  setwd("./04_Results/")
  write.csv(clusterResults, 'class_13_nCluster_onDetections.csv', row.names=FALSE)
}
...
#Nmax - On the fully automated labels
{
  ...
  setwd(parent_dir)
  setwd("./04_Results/")
  write.csv(nmaxResults, 'class_13_nMax_onDetections.csv', row.names=FALSE)  
}