...
#For the image
logo_file <- magick::image_read("./06_Imgs/diplodusVulgaris_outline.jpg")

#EPINEPHELUS MARGINATUS
#CALIBRATION
{
setwd("./03_Datasets/dataset_1/")
bbs_Overall <- read.csv("combined_data_1.csv", sep=",")
bbs <- read.csv("boundingboxes_class1.csv", sep=",")
...
bbs_actual <- read.csv("class_1_nact.csv", sep=",")
bbs_nmax <- read.csv("class_1_nMax_onTestLabels.csv", sep=",")
bbs_nCluster <- read_csv("class_1_nCluster_onTestLabels.csv")
bbs_NTCN <- read_csv("class_1_Ntcn_onTestLabels.csv")
bbs_nimproved <- read.csv("class_1_nheuristic_onTestLabels.csv", sep=",")
...
#Before running this part, copy the best performing NHeuristic into the ./04_Results/ folder and name the file 'class_13_nheuristic_onDetections.csv'
{
  ...
  bbs_actual <- read.csv("class_1_nact.csv", sep=",")
  bbs_nmax <- read.csv("class_1_nMax_onDetections.csv", sep=",")
  bbs_nCluster <- read_csv("class_1_nCluster_onDetections.csv")
  bbs_NTCN <- read_csv("class_1_Ntcn_onDetections.csv")
  bbs_nimproved <- read.csv("class_1_nheuristic_onDetections.csv", sep=",")
