...
bbs1 <- read.csv("./boundingboxes_class1.csv")
bbs13 <- read.csv("./boundingboxes_class13.csv")
bbs17 <- read.csv("./boundingboxes_class17.csv")
...
write.csv(joined1,"./boundingboxes_class1.csv", row.names = FALSE)
...
write.csv(joined13,"./boundingboxes_class13.csv", row.names = FALSE)
...
write.csv(joined17,"./boundingboxes_class17.csv", row.names = FALSE)
...
#Save the file
write.csv(finalFile,"./03_Datatsets/boundingboxes_joined_3heads.csv", row.names = FALSE)
