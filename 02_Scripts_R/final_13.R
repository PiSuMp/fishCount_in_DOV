...
#For the image
logo_file <- magick::image_read("./06_Imgs/grouper_image.png")

#EPINEPHELUS MARGINATUS
#CALIBRATION
{
setwd("./03_Datasets/dataset_13/")
bbs_Overall <- read.csv("combined_data_13.csv", sep=",")
bbs <- read.csv("boundingboxes_class13.csv", sep=",")
...
bbs_actual <- read.csv("class_13_nact.csv", sep=",")
bbs_nmax <- read.csv("class_13_nMax_onTestLabels.csv", sep=",")
bbs_nCluster <- read_csv("class_13_nCluster_onTestLabels.csv")
bbs_NTCN <- read_csv("class_13_Ntcn_onTestLabels.csv")
bbs_nimproved <- read.csv("class_13_nheuristic_onTestLabels.csv", sep=",")
...
#Before running this part, copy the best performing NHeuristic into the ./04_Results/ folder and name the file 'class_13_nheuristic_onDetections.csv'
{
  ...
  bbs_actual <- read.csv("class_13_nact.csv", sep=",")
  bbs_nmax <- read.csv("class_13_nMax_onDetections.csv", sep=",")
  bbs_nCluster <- read_csv("class_13_nCluster_onDetections.csv")
  bbs_NTCN <- read_csv("class_13_Ntcn_onDetections.csv")
  bbs_nimproved <- read.csv("class_13_nheuristic_onDetections.csv", sep=",")
